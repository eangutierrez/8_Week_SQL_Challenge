...
/*
Explanation: The customer_nodes table has all the information we need.  
...
/*
Explanation: The customer_nodes and regions tables has all the 
...
/*
Explanation: The customer_nodes and regions tables have all the 
