...
/*
1. To test out a few different hypotheses - the Data Bank team wants to run an experiment 
...
-- data elements to help the Data Bank team estimate how much data will need to be provisioned 
-- for each option:
...
/*
Explanation: The data elements will be set the foundation of each of the
