...
/*
-- 1.  In a single query, perform the following operations and generate a 
...
- Add a month_number with the calendar month for each week_date value  
	as the 3rd column
...
- Ensure all null string values with an "unknown" string value in the 
	original segment column as well as the new age_band and demographic 
	columns
...
*/
/*
Explanation: To clean the weekly_sales data and use its 
