...
/*
Explanation: We can't start our query from the members table.  This is because 
...
/*
Explanation: The sales table has all the information we need: the customer_id 
...
/*
Explanation: The data that we want in on the sales and menu tables. Our table
...
/*
Explanation: The information we are looking for is on the sales and menu tables.
...
/*
Explanation: The information we are looking for is on the sales and menu tables. We must
...
/*
Explanation: The information we are looking for is on the sales and members table. However, 
...
/*
Explanation: The information we are looking for is spread throughout the three tables. 
...
/*
Explanation: The information we need is on the sales and menu tables.  To begin, 
...
/*
Explanation: The information we need is spread throughout the three tables.  To begin, 
...
/*
Explanation: We are tasked with producing the table's output by ourselves. The data we
...
/*
Explanation: This query uses the query from Bonus Question 1 as a base. It asks us to
