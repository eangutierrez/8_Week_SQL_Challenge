...
-- there are no right or wrong answers, but answers that make sense from both a technical and a business perspective 
-- make an amazing impression!

-- 1. How would you calculate the rate of growth for Foodie-Fi?
/*
Explanation: For subscription businesses, the main pillars
...
/*
Explanation: There are several important metrics that
...
-- 3. What are some key customer journeys or experiences that you 
-- would analyse further to improve customer retention?

/*
Explanation: I would love to analyze the following
...
-- 4. If the Foodie-Fi team were to create an exit survey shown to customers 
-- who wish to cancel their subscription, what questions would you include in the survey?
/*
Explanation: These are some of the exit survey questions
I would include:
...
-- 5. What business levers could the Foodie-Fi team use to reduce 
-- the customer churn rate? How would you validate the effectiveness of your ideas?

/*
Explanation: These are some of the levers Foodie-Fi 
